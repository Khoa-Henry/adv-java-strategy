...
//        Student student2 = new Student("555 1st North St.", 51515, "Illinois", "262-414-5555", "Bob Fredrickson", 32);
        ...
        Student student1 = new Student(new Address("750 Main St.", 55555, "Wisconsin", "414-262-5555"), "414-262-5555", "Sue Shoe", 23);
        Student student2 = new Student(new Address("555 1st North St.", 51515, "Illinois", "262-414-5555"), "262-414-5555","Bob Fredrickson", 32);
